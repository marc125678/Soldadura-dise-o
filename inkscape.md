...
*![foto logo vectorizado imagen que no me gustaba](https://github.com/marc125678/Soldadura-dise-o/blob/main/Captura%20de%20pantalla%20de%202021-04-15%2010-13-05.png) 
 ...
 ![](https://github.com/marc125678/Soldadura-dise-o/blob/main/Captura%20de%20pantalla%20de%202021-04-19%2010-53-36.png)
  объяснение того, что такое типографика
  Это могут быть файлы ttf и otf векторный тип не svg, это векторный тип a a смайлик символ доллара b символ рака c шрифт остается на компьютере при использовании pdf включает переносимый шрифт формата документа обычно от 3 до 50 КБ обычно меньше фотографии шрифты - это шрифты, включаемые в отдельный файл (встраивание или эпипорт шрифта для включения отдельного файла называется передачей текста в контуры или штрихи. Форма x1 y, = 0,0 x2 y, = 1, 0 x3 y2 = 3, 3,2;>
  примеры: удар [мемы] arial hermetica times mew roman nunito y darker.
